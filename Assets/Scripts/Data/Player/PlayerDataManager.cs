...
public class PlayerDataManager : IDataManager
{
    ...
    private string _defaultPath = IOUtil.CombinePath(Constant.Path.DEFAULT_DATA_PATH, "Player/");
    ...
    public void LoadDataFromJson()
    {
        ...
        else
        {
            ...
            playerData = new PlayerData { id = "Player1", forceStrength = 10, jumpStrength = 60 }; // 기본값 설정
        }
    }
